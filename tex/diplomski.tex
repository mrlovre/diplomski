...
%  Organizacija poglavlja je sljedeća: \ldots
  ...
  \begin{description}
    ...
    Suprotno tome, u kratkoj poziciji, količina vrijednosnice u portfelju je negativna, što znači da je investitor prethodno prodao određenu količinu vrijednosnice koju nije posjedovao, i time se obavezao na kasniju kupnju iste količine.
...
%  It adapts to the inconsistence of preferences by picking variable number of assets into the portfolio.
  ...
  Although the research in this thesis has been done on financial time series, mathetmatical and statistical methods used can easily prove useful in other applications.
