...
%  Organizacija poglavlja je sljedeća: \ldots
  ...
  \begin{description}
    ...
    \item[Solventnost] 
    \item[Indeks]
    \item[Logaritamska cijena] dobiva se jednostavnim logaritmiranjem obične cijene.
    ...
    \item[Povrat]
      $r\q(t_1, t_2\w)$ je udio promjene cijene između dva vremenska trenutka $t_1$ i $t_2$:
      \begin{equation*}
      ...
      \end{equation*}
      Vrijedi da je $r\q(t_1, t_2\w) \approx R\q(t_1, t_2\w)$ kada je $V\q(t_1\w) \approx V\q(t_2\w)$:
      \begin{equation*}
...
\chapter{Metode i koncepti}
  ...
  Ideja metode Engle-Granger\citep{engle-granger} je u prvom koraku estimirati stacionaran proces $U\q[t\w]$ koji je linearna kombinacija cijena $P_X\q[t\w]$ i $P_Y\q[t\w]$, zatim u drugom koraku provjeriti je li estimirani proces zaista stacionaran.
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=1.0\linewidth]{graphics/residual.png}
    \caption{
...
%  Tretiranje parova dionica zasebno, nedostaje interakcija između svih dionica zajedno.
  ...
  Relacija preferencije koristi se u mikroekonomici u svrhu vrednovanja dobara \citep{inzeko}.
...
%  Setting lower values for parameter $\alpha$ yields denser graphs, and setting $\alpha = 0$ always yields complete graphs.
  ...
  \begin{figure}[p]
    \centering
    \includegraphics[width=\linewidth]{graphics/trading-signal.png}
  ...
  \begin{figure}[p]
    \centering
    \includegraphics[width=\linewidth]{graphics/trading-prices.png}
  ...
  \begin{figure}[p]
    \centering
    \includegraphics[width=\linewidth]{graphics/trading-diffs.png}
...
%These findings suggest that the proposed method produces consistent returns and may be feasible in a live market setting.
  ...
  \begin{figure}[p]
    \centering
    \includegraphics[width=\linewidth]{graphics/sharpes1.png}
