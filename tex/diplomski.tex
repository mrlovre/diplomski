...
\zahvala{Zahvaljujem svojoj obitelji, svim dragim prijateljima i profesorima na Fakultetu elektrotehnike i računarstva, na višegodišnjoj potpori i pružanju novih znanja i vještina bez kojih ovaj rad ne bi mogao nastati.}
...
%These findings suggest that the proposed method produces consistent returns and may be feasible in a live market setting.
  ...
  \begin{table}[h]
    \centering
    \caption{Rezultati testiranja nad S\&P 500 skupom.}
    \label{table:spfull2}
    \begin{tabular}{lr}
      \toprule
      Rezultati: & \\
