...
\chapter{Metode i koncepti}
  ...
  \begin{figure}[p]
    ...
    \caption{
      ...
      Svjetlijim nijansama tih boja prikazana je punom linijom srednja vrijednost, i crtkanom linijom raspon udaljenost za jednu devijaciju od srednje vrijednosti; srednja vrijednost i devijacija izračunate su na proteklom vremenskom periodu $T$ duljine 120 dana.
    }
    \label{fig:ab-prices}
  \end{figure}
...
%These findings suggest that the proposed method produces consistent returns and may be feasible in a live market setting.
  ...
  Pri izračunavanju momenata (srednja vrijednost, varijanca) vremenskih nizova nad prozorima konačne duljine, pokazalo se neefikasnim izračunavati svaki prozor zasebno u svakom koraku, jer se većina uzoraka između dva susjedna prozora ponavlja.
  ...
  Stoga se isplati potražiti rekurzivne izraze za srednju vrijednost i varijancu kako bi se izračun mogao obaviti na učinkovitiji način.
  
  Za početak, potrebno je razlikovati obične, centrirane, i normirane momente.
