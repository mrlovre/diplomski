...
\chapter{Metode i koncepti}
  ...
  \begin{enumerate}
    ...
    \item u skladu s utvrđenim provodi se trgovanje parovima vrijednosnica na način da se u jednoj od njih zauzme kratka, a u drugoj duga pozicija, te se u idućem trenutku izlazi iz tih pozicija, osim ako se i u idućem trenutku utvrdi da treba ostati u istim pozicijama.
  \end{enumerate}
...
%  The most preferred assets should be bought while the least preferred should be short-sold if possible.
  ...
  Vrijednosnice s trenutačno najvećom preferencijom preporučeno je kupiti, dok je one s najmanjom preferencijom preporučeno prodati, odnosno zauzeti kratku poziciju ukoliko je to moguće.
